...
const MESSAGES = {
  en: {
    ...
    'connect.peerCold': 'not running — sending will ask before waking it',
    ...
    'consent.wake.header': 'Peer is not running',
    'consent.wake.question': '"{peer}" is not running right now. Wake it and deliver this message?',
    'consent.wake.detail':
      'Waking it resumes that conversation and starts a new turn there, which costs tokens. Declining sends nothing.',
    'consent.wake.yes': 'Wake it and deliver',
    'consent.wake.yesDesc': 'Resume the conversation and deliver the message',
    'consent.wake.no': 'Cancel',
    'consent.wake.noDesc': 'Send nothing',
  },
  ...
  zh: {
    ...
    'connect.peerCold': '未运行 —— 发送时会先询问是否唤醒它',
    ...
    'consent.wake.header': '对端未运行',
    'consent.wake.question': '「{peer}」当前没有运行。要唤醒它并投递这条消息吗？',
    'consent.wake.detail': '唤醒会让那个对话恢复运行并开启新一轮，会消耗 token。拒绝则不发送任何内容。',
    'consent.wake.yes': '唤醒并投递',
    'consent.wake.yesDesc': '恢复该对话并投递这条消息',
    'consent.wake.no': '取消',
    'consent.wake.noDesc': '什么都不发送',
  },
}
